...
The evaluation demonstrates that the prototype is usable for a controlled demo. On the 12-question GTU evaluation set, the system reached a 100\% source hit rate and a 91.67\% answer keyword hit rate. The top-1 source hit rate of 83.33\% and median latency of 6.58 seconds show that the system works but still needs optimization before it can be considered production-ready.
