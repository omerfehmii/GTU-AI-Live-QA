...
\usepackage[a4paper,top=25mm,bottom=25mm,left=32.5mm,right=32.5mm]{geometry}
...
\title{AI/RAG-Based Live GTU Q\&A System}
\author{\"Omer Fehmi \c{C}ak{\i}c{\i}}
\faculty{Faculty of Engineering}
\department{Computer Engineering Department}
\supervisor{Mehmet G\"okt\"urk}
\theyear{2026}
